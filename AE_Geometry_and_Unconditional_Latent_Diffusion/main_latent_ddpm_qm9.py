...
if __name__ == '__main__':
    ...
    dataset_train = torch.utils.data.TensorDataset(torch.tensor( np.concatenate([data['emb_2d'], data['emb_3d']], axis=1) )) # shape = (N, 250+250)
    ...
    dataset_val = torch.utils.data.TensorDataset(torch.tensor( np.concatenate([data['emb_2d'], data['emb_3d']], axis=1) ))
