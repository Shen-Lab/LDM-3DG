...
class Molecule3D(InMemoryDataset):
    def __init__(
        ...
        self.smiles2emb_dict = torch.load('/scratch/user/yuning.you/project/graph_latent_diffusion/hgraph2graph/hiervae_smiles2emb_dict_new.pt', map_location='cpu')
    ...
    def get(self, idx):
        ...
        data.n_edges_radius = data.radius_edge_index.shape[1]
