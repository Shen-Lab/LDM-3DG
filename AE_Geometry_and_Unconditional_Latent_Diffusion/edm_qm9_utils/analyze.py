try:
    ...
    from edm_qm9_utils.rdkit_functions import BasicMolecularMetrics
    use_rdkit = True
except ModuleNotFoundError:
    use_rdkit = False
import edm_qm9_utils.dataset as dataset
import torch
import matplotlib
matplotlib.use('Agg')
...
from edm_qm9_utils import bond_analyze
import pdb
...
def check_stability_yy(positions, atom_type, dataset_name='qm9'):
    assert len(positions.shape) == 2
    assert positions.shape[1] == 3
