...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', type=str, default='./custom_data')
    ...
    config2=ckpt['config']
    config2.data.path = './custom_data'
    del config2.data['split']
    ...
    zs = torch.load('./samples_latent/sample_z_custom.pt')
    smiles = torch.load('./samples_latent/sample_smiles_custom.pt')
    ...
    for data_id in [0]:
        ...
        torch.save(result, os.path.join(result_path, f'result_custom.pt'))